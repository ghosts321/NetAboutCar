...
public class ComAppeals {
	private String appeal_no;//申诉编号
	private String appeal_status;//处理状态
	private String creditcode;//统一社会信用代码
	private String com_license;//营业许可证号
	private String appeal_text;//申诉内容
	private String appeal_file;//申诉材料
	private Date appeal_date;//申诉日期
	private String deal_result;//处理意见
	private String dealer;//经办人
	private String review_result;//审核意见
	private String reviewer;//审核人
	private String appeal_result;//综合结论
