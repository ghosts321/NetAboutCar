...
public class comComplainDistribute implements Serializable {
   
	private int complain_distribute_id;//投诉受理ID
	...
	public int getComplain_distribute_id() {
		return complain_distribute_id;
	}
	public void setComplain_distribute_id(int complain_diste_compy_id) {
		this.complain_distribute_id = complain_diste_compy_id;
	}
