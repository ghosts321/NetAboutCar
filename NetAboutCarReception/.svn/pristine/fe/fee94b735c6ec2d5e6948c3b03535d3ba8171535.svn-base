	...
	<head>
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				$("#remark").formValidator({onshow:"请输入说明"}).functionValidator({fun:isNotNull});//fun:isNotNull
		...
		<div class="buss_area">
			<div class="personalmenu">
				<jsp:include page="/WEB-INF/jsp/driver/personalMenu.jsp">
					<jsp:param name="leftmenu" value="driver4"/>
				</jsp:include>
			</div>
			<div id="workarea" class="workarea">
				<div class="title_area">
					<div class="title">网约车驾驶员证补办
						<div class="help">
				...
				<div>
					<form action="${basePath}driver/addReissueApply.action" method="post" name="form1" id="form1">
