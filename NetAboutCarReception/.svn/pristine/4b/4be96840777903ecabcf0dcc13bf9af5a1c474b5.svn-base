				...
				<div class="title_area">
					...
					<table width="100%" border="0" cellpadding="5" cellspacing="2" class="table_main">
						...
						<tr>
							...
							<td align="center">${apply.carId}</td>
							...
							<td align="center">
								...
								<c:if test="${apply.applyType == '6' }">注销</c:if>
							</td>
							<td align="center">
								<a href="#" onclick="funcGo(this,'${basePath}vehicle/openCarDetail.action?applyid=${apply.applyId}')">详情</a>
								|<a href="#" onclick="funcGo(this,'${basePath}vehicle/openProgress.action?applyId=${apply.applyId}&applytype=${apply.applyType}')">查看进度</a>
							</td>
						</tr>
						</c:forEach>
					</table>
