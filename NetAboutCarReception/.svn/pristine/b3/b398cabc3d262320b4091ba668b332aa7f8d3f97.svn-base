						...
						<table width="100%" border="0" cellpadding="5" cellspacing="2">
							<tr height="40">
								...
								<td width="30%" align="left">
									<input class="reg_input" size="25" name="name" id="name" type="text" value="中国六建天津项目部" readonly="readonly"/>
								</td>
								<td align="left">
							...
							<tr height="40">
								...
								<td align="left">
									<input class="reg_input" size="25" name="idCard" id="idCard" type="text" readonly="readonly" value="WDBG127810P57B6PB"/>
								</td>
								<td align="left">
							...
							<tr height="40">
								...
								<td align="left">
									<input class="reg_input" size="25" name="driveCard" id="driveCard" type="text" readonly="readonly" value="王亚云"/>
								</td>
							</tr>
							<tr height="40">
								<td align="right">法人身份证：</td>
								<td align="left">
									<input class="reg_input" size="25" name="driveCard" id="driveCard" type="text" readonly="readonly" value="421199003291302342"/>
								</td>
								<td align="left"></td>
							</tr>
							<tr height="40">
							...
							<tr height="40">
								...
								<td align="left">
									<input type="text" class="reg_input" name="cardDate" id=dt2 placeholder="请选择日期" size="25" value="2015-08-08">
									<div id="dd2"></div>
								</td>
								<td align="left"></td>
							</tr>
