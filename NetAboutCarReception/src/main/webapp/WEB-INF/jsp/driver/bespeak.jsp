		...
		if(msgg == "success"){
		...
		}else if(msgg != "null")
		 {
			 ...
			 $(function(){
				...
				var selectId = "";
				$.getJSON("${basePath}driver/getDisinctDate.action",function(datas){
			...
			var ajs =	 function ajss(date){
				$.ajax({
			            type: "post",
			            url: "${basePath}driver/getBespeakSum.action",
			            data: "date=" + date,
	...
	<body>
		<div class="buss_area">
			...
			<div id="workarea" class="workarea">
				...
				<div>
					<form action="${basePath }driver/addBespeak.action" method="post" name="form1" id="form1">
						<table width="100%" border="0" cellpadding="5" cellspacing="2">
							...
							<tr height="40">
								...
								<td colspan="2" align="left">
									<textarea class="reg_textarea" cols="30" rows="3" name="address" id="address" disabled="disabled"></textarea>
								</td>
							</tr>
							<tr>
								<td></td>
