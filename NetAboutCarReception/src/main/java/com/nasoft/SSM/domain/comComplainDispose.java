...
public class comComplainDispose implements Serializable {

	private int complain_dispose_id;//投诉处理id
	...
	public int getComplain_dispose_id() {
		return complain_dispose_id;
	}
	public void setComplain_dispose_id(int complain_dispose_id) {
		this.complain_dispose_id = complain_dispose_id;
	}
