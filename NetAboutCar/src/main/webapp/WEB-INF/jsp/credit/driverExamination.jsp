...
var TableInit = function () {
	...
	oTableInit.Init = function () {
	    $('#tradeList').bootstrapTable({
	        url: 'drvExamination.action',         //请求后台的URL（*）
	        method: 'post',                      //请求方式（*）
	        dataType: "json",
	       ...
	       /*  pageNumber:1,                       //初始化加载第一页，默认第一页
	        ...
	        },
            {
                ...
                title: '计分明细',
                formatter:function(value, row, index){
                	var html = "<button type='button' class='btn btn-default' onclick='showDetail(\"" + row.drivecardno + "\")'><span class='glyphicon glyphicon-wrench' aria-hidden='true' ></span>详细</button>&nbsp;";
                	 html+= "<button type='button' class='btn btn-default' onclick='showArchive(\"" + row.drv_license + "\")'><span class='glyphicon glyphicon-wrench' aria-hidden='true' ></span>查看驾驶员档案</button>&nbsp;";
     	            return html;
                }
            }]
	    });
