...
angular.module('wyc',[]).controller('WycController',function($http,$scope){
	$scope.appealResult='${cad.appealResult}';
		            ...
		            <div class="panel-body">
		                ...
		                <table width="100%" border="1" cellpadding="5" cellspacing="2" class="table">
							...
							<tr>
							    ...
							    <td colspan="3" ng-show='appealResult=="0"'>申诉无效，维持记分</td>
							    <td colspan="3" ng-show='appealResult=="1"'>同意申诉，撤销记分</td>
							</tr>
							<tr>
							    <th style="text-align: right;" >处理意见：</th>
							    <td colspan="3">${cad.dealResult }</td>
							</tr>
							<tr>
							    <th style="text-align: right;" >处理时间：</th>
							    <td colspan="3"><fmt:formatDate  value="${cad.updateTime}" type="both" pattern="yyyy-MM-dd hh:mm:ss" /></td>
							</tr>
		                </table>
		           	</div>
		   		</div>
