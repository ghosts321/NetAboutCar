...
function submitForm(r,obj){
	var deal_result = $("#deal_result").val();
	if(deal_result == ""){
		$("#deal_result").tips({
			side:3,
            msg:'请填写处理结论！',
		...
		if(confirm($(obj).text()+"，确定要提交此处理结论？")){
			$('#form1').attr('action',$('#form1').attr('action')+'?appeal_result='+r);
			$("#form1").ajaxSubmit({
...
<div class="container">
<form action="<%=basePath %>credit/auditComAppealDetail.action" name="form1" id="form1" method="post" enctype ="multipart/form-data">
	<div id="zhongxin">
		            ...
		            <div class="panel-body">
		                ...
		                <table width="100%" border="1" cellpadding="5" cellspacing="2" class="table">
							...
							<tr>
							    ...
							    id="deal_result" name="deal_result" 
				...
				<table width="100%" border="0" cellpadding="5" cellspacing="2">
					<tr>
						<td colspan="4" style="text-align: center; padding-top: 5px;padding-bottom: 5px;">
							<input type="hidden" id="rec_no" name="rec_no" value="${cad.rec_no}" />
