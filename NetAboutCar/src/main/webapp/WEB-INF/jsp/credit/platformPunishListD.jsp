...
<script type="text/javascript">
	var _set = {};
	angular.module('wyc', []).controller('WycController',
			function($http, $scope) {
	...
	<div class="panel-body">
		<div class="page-header">
			<h1 style="font-size: 15px;">
				诚信考核 <small style="font-size: 15px"> <i
					class="icon-double-angle-right"></i> 运营平台考核已生成处分名单
				</small> <small style="font-size: 15px"> <i
					class="icon-double-angle-right"></i> ${listNo }
				</small>
			</h1>
		</div>
		<br />
