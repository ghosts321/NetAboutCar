...
<form  action="gxsjzl.action" name="contentForm" id="contentForm" method="post" enctype="multipart/form-data" >
	
		<div id="zhongxin" align="center" style="padding-top:30px">
		<table >
		    <tr>
			    <td colspan="2" align="left">修改统计数据种类</td>
			    <td>&nbsp;</td>
			</tr>
			<tr>
				<td style="text-align: right;">数据代码：</td>
				<td align="left"><input type="text" readonly class="disabled" ng-model='sjzl.dataCode' name="dataCode" id="dataCode" value="" placeholder="数据代码"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="left"><div><textarea ng-model='sjzl.dataSql' name="dataSql" id="dataSql" rows=5 cols=60></textarea></div>
			...
			<!-- <tr>
				<td style="text-align: right;">执行周期：</td>
				<td align="left"><select ng-model="sjzl.exec_period" ng-options='p.value as p.text for p in periodtypes'></select>
				</td>
			</tr> -->
			
			<tr>
				<td style="text-align: right;">执行时间：</td>
				<td align="left"><div><input type="text"  ng-model='sjzl.execTime' name="execTime" id="execTime" value="" placeholder="执行时间"/></div>
			...
			<tr>
				...
				<td align="left"><div><a href="javascript:void()" class='check-span check-span-select'><span>创建</span>
