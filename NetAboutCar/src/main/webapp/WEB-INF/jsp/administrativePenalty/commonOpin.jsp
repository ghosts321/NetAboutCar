...
function toAdd(){
	var diag = new top.Dialog();
	 diag.Drag=true;
	 diag.Title ="新增常见意见";
	 diag.URL = '<%=basePath%>penalty/commonOpinAdd.action';
	 diag.Width = 450;
	 diag.Height = 500;
...
function toAccept(abnormity_id){
	var diag = new top.Dialog();
	 diag.Drag=true;
	 diag.Title ="修改常见意见";
	 diag.URL = '<%=basePath%>penalty/commonOpinUpdate.action';
	 diag.Width = 450;
	 diag.Height = 500;
	 diag.CancelEvent = function(){ //关闭事件
		if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
	...
	<div class="panel-body">
		<div class="page-header" >
			<h1 style="font-size: 15px;">
				...
				<i class="icon-double-angle-right"></i>常见意见
				</small>
			</h1>
		</div>
