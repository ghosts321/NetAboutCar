...
function toRegister(id){
	document.caseAppealPage.action="caseAppealPage.action?id="+id;
	$("#caseAppealPage").submit();
...
<body>
<div class="container">
<form name="caseAppealPage" id="caseAppealPage" method="post" >
<input type="hidden" id="caseId" name="caseId" value="${plantcaseappeal.caseId}" />
		...
		<table border="1" class="table">
			...
			<tr>
				...
				<td style="width:200px;" colspan="3">${plantcaseappeal.appealuserid }</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style="width:200px;" colspan="3">${plantcaseappeal.appealcontent }</td>
			</tr>
			<tr>
