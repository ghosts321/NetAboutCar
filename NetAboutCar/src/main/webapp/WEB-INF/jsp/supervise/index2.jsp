   ...
   <div id="controller" align="center">
	...
	function show(){
		...
		for (var i = 0; i < 10; i++) {
			...
			var label = new BMap.Label("京A·LK888"+i,{offset:new BMap.Size(20,-10)});
			label.setStyle({ 
				color : "white", 
				fontSize : "16px", 
			...
			var infoWindow = new BMap.InfoWindow("<h4 style='margin:0 0 5px 0;padding:0.2em 0'>张师傅(男)</h4><img  id='imgDemo' src='<%=request.getContextPath()%>/static/images/zp.jpg' width='121' height='140' /><br>车牌：京AK8888"+i+"<br>电话：18611122231<BR>");
