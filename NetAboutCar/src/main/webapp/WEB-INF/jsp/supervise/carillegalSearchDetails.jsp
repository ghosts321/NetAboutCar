...
<form action="driverwzwfAddDetermine.action" name="driverwzwfAddDetermine" id="driverwzwfAddDetermine" method="post" >
		...
		<table border="1" class="table">
			...
			<tr>
				...
				<td style="text-align: left; width:220px;">${carIllegalInfo.driver_certno}</td>
			</tr>
			<tr>
				<th style="text-align: right;">所属平台：</th>
				<td style="text-align: left;">${carIllegalInfo.company_name}</td>
			    <th style="text-align: right;">车牌号：</th>
				<td style="text-align: left;">${carIllegalInfo.car_num}</td>
			</tr>
			<tr>
				<th style="text-align: right;">违规地点：</th>
				<td style="text-align: left;">${carIllegalInfo.illegal_address}</td>
			...
			<tr>
				...
				${carIllegalInfo.illegal_content}
			    </td>
			</tr>
			<tr>
