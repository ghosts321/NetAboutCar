...
<script type="text/javascript">
	...
	function addmenu(){
		 ...
		 diag.URL = 'jsp/menu/menu_add.jsp';
		 diag.Width = 223;
		 diag.Height = 256;
			...
			<table border='0'>
				<tr>
					...
					<td>
						<span class="input-icon">
							<input autocomplete="off" type="text" name="USERNAME" value="${pd.USERNAME }" placeholder="这里输入关键词" />
				...
				<table id="table_report" class="table table-striped table-bordered table-hover" >
					...
					<tr>
						...
						<td class="center">赵四</td>
						<td class="center">铁岭</td>
