...
public class CxkhDrvBlacklist implements Serializable{
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "CxkhDrvBlacklist";
	public static final String ALIAS_ID = "id";
	public static final String ALIAS_DRV_LICENSE = "é©¾é©¶è¯�å�·ï¼ˆè�¥è¿�ï¼‰";
	public static final String ALIAS_DRV_ID = "èº«ä»½è¯�å�·";
	public static final String ALIAS_DRV_NAME = "å§“å��";
	...
	public static final String ALIAS_STATUS = "çŠ¶æ€�ï¼ˆ0ï¼šæœªç§»é™¤ 1ï¼šç§»é™¤ï¼‰";
	...
	public void setDrvId(String value) {
		this.drvId = value;
	}
