		...
		<table border="1" class="table">
			...
			<tr>
				...
				<td style="width:200px;">
					${drvplantcaseinfo.carid }
				</td>
			</tr>
			<tr>
				<th style="text-align: right;width: 100px;">驾驶证号码：</th>
				<td style="width:200px;">${drvplantcaseinfo.drivcarno }</td>
				<th style="text-align: right;">案件来源：</th>
				<td>${drvplantcaseinfo.casesource }</td>
			    
			</tr>
			<tr>
				<th style="text-align: right;">行政区划：</th>
				<td id="nationTd">${drvplantcaseinfo.areacode }</td>
				<th style="text-align: right;">组织机构：</th>
				<td>
					${drvplantcaseinfo.instid }
				</td>
			...
			<tr>
				...
				<td >
					${drvplantcaseinfo.casetime }
				</td>
			    <th style="text-align: right;">最后受理时间：</th>
				<td >
					${drvplantcaseinfo.updatetime }
				</td>
			</tr>
			<tr height="30px">
			...
			<tr>
				...
				<td colspan="3">${drvplantcaseinfo.evidenceview }</td>
			</tr>
			...
			<c:choose>
			<c:when test="${drvplantcaseinfo.punishtype=='0001'}">
				<td colspan="3">
					口头警告
				</td>
			</c:when>
			<c:when test="${drvplantcaseinfo.punishtype=='0002'}">
				<td colspan="3">
					两百元一下罚款
				</td>
			</c:when>
			<c:when test="${drvplantcaseinfo.punishtype=='0003'}">
				<td colspan="3">
					暂扣或吊销驾驶证
				</td>
			</c:when>
			...
			<tr>
				...
				<td colspan="3">${drvplantcaseinfo.punishcontent }</td>
			</tr>
			<tr>
