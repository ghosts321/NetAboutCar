		...
		this
				.each(function() {
					...
					var j = a(this)
							...
							.after(
									'<div class="spinner-buttons btn-group btn-group-vertical">						<span class="btn spinner-up btn-mini '
											+ e
											+ '">						<i class="'
											+ f
											+ '"></i>						</span>						<span class="btn spinner-down btn-mini '
											+ g
											+ '">						<i class="'
											+ i
											+ '"></i>						</span>						</div>')
							.closest(".ace-spinner").spinner(c);
					a(this).on(
					...
					a(this)
							...
							.after(
									'<div class="dropdown dropdown-colorpicker"><a data-toggle="dropdown" class="dropdown-toggle" href="#"><span class="btn-colorpicker" style="background-color:'
											+ f
											+ '"></span></a><ul class="dropdown-menu dropdown-caret'
