		  	...
		  	<div style="padding-top:10px;" class="tab-content">
		  		<div class="panel panel-default">
		            <div class="panel-body">
		                ...
		                <form action="<%=basePath %>plantcaseappeal/drvanalysisList.action" method="post" name="form1" id="form1" class="form-horizontal">
		    ...
		    series : [
		        {
		            ...
		            center: ['50%', '60%'],
		            data:[
		                {value:'${map.one}', name:'稽查执法查扣违章'},
		                {value:'${map.two}', name:'信访投诉违章'},
