...
var TableInit = function () {
	...
	oTableInit.Init = function () {
	    $('#tradeList').bootstrapTable({
	        url: 'getDrvNameList.action',         //请求后台的URL（*）
	        method: 'post',                      //请求方式（*）
	        dataType: "json",
...
<body>
<div class="container">
	<form action="addDrvBlacklist.action" id="form" method="post" enctype="multipart/form-data">
		<div id="zhongxin">
		<div style="padding-top:30px;"></div>
        <div class="panel panel-default">
        <div class="panel-body">
        <span style="font-size:15px" class="title">驾驶员</span>
		<table id="tradeList">
		</table>
		</div>
		</div>
