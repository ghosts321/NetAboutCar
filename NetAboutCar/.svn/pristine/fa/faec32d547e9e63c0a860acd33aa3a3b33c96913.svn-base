...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tradeList').bootstrapTable({
            url: 'comDaichuliDetails.action',         //请求后台的URL（*）
            method: 'post',                      //请求方式（*）
            dataType: "json",
            ...
            columns: [{
                ...
                title: '投诉状态',
                formatter:function(value, row, index){
	            	if(row.compn_state == 1){
	            		return "待提交";
	            	}else if(row.compn_state==2){
	            		return "待受理";
	            	}else if(row.compn_state==3){
	            		return "待处理";
            ...
            <div class="panel-body">
                ...
                <input hidden="true" id=allot_depme name=allot_depme value="${allot_depme}">
                    <div class="form-group" style="margin-top:15px">
                        ...
                        <label class="control-label col-sm-1" style="font-weight: normal;" for="company_id">最后受理时间</label>
