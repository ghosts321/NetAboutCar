        ...
        $('#tradeList').bootstrapTable({
            ...
            columns: [{
                ...
                formatter:function(value, row, index){
	                	...
	                	html += "<button type='button' class='btn btn-default' onclick='toDetail(\""+row+"\")'><span class='glyphicon glyphicon-pencil' aria-hidden='true' >修改历史</button>";
						return html;
                }
            }],
            data: [{
                ...
                person: '张三',
                status: '待处理',
                crimeTime: '2017-03-09 16:50:34',
                finalAcceptTime: '2017-03-09 16:50:34',
            },{
                id: 'C190C8008',
                vehicle_no: '京AF3952',
                source: '稽查执法查扣违章',
	...
	<div class="panel-body">
		<div class="page-header" >
			<h1 style="font-size: 15px;">
				...
				<i class="icon-double-angle-right"></i>案件修改
				</small>
			</h1>
		</div>
