 ...
 *
 */
public class CtlAssembleCarMonitor implements Serializable {
	...
	public Integer getPosition_time() {
		return position_time;
	}

	public void setPosition_time(Integer position_time) {
