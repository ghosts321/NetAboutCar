...
<form  action="tohandlecomit.action" name="addForm" id="addForm" method="post" enctype="multipart/form-data" >
		...
		<td style="text-align:left;"colspan="5"><strong>投诉人基本信息</strong></td>
			...
			<tr>
				...
				<td style="text-align:left;" colspan="2">${comcomplaintinfo.compn_number}</td>	
			</tr>
			<tr></tr>
			<tr>
			 ...
			 <tr>  <td style="text-align: right;">现住地址：</td>
				...
				<tr>
		<td style="text-align:left;"colspan="5"><strong>被投诉平台信息</strong></td>
		</tr>
				<tr> <td style="text-align: right;">平台名称：</td>
				<td style="text-align:left;"colspan="4">${comcomplaintinfo.compn_compy}
				     <input type="hidden" id="complain_code" name="complain_code" value="${comcomplaintinfo.complain_code}"/>
				      <input type="hidden" id="complain_info_id" name="complain_info_id" value="${comcomplaintinfo.complain_info_id}"/>
				       <input type="hidden" id="compn_state" name="compn_state" value="${comcomplaintinfo.compn_state}"/>
				       <input type="hidden" id="compn_compy" name="compn_compy" value="${comcomplaintinfo.compn_compy}"/>
				       <input type="hidden" id="compn_time" name="compn_time" value="${comcomplaintinfo.compn_time}"/>
				       <input type="hidden" id="compn_reason" name="compn_reason" value="${comcomplaintinfo.compn_reason}"/>
		...
		<tr>
		<td style="text-align: center; width:200px"><strong>处理时间</strong></td><td style="text-align:center; width: 130px"><strong>处理部门</strong></td><td style="text-align:center;width: 91px; "><strong>处理人</strong></td>
		...
		<td style="text-align:left;"colspan="5"><strong>处理信息</strong></td>
			...
			<!-- 	  <tr>
			    ...
			    <input type="radio" name="blacklist" id="blacklist" value=""  style="width:30px;height:px" onclick="avalue()" />加入黑名单 
			    <input type="radio" name="blacklist" id="blacklist" value="" style="width:30px;height:px" onclick="novalue()"/>不加入黑名单 
			    </td>
			</tr> -->
			<tr>
			...
			<tr>
			    ...
			    <td style="text-align:left;"colspan="4"><textarea name="dis_idea" id="dis_idea" style="width:220px;height:80px;" ></textarea>
			       <c:if test="${comcomplaintinfo.compn_state=='6'}">
			      <input type="hidden" id="disidea" name="disidea" value="${comcomplaindispose.dis_idea}"/>       
			       </c:if>
			    </td>
			</tr>
			<tr>
