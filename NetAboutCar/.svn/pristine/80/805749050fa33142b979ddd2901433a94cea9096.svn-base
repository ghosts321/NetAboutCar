		...
		<form action="<%=basePath %>pilotApply/authentication.action" name="form1" id="form1" method="post" >
				...
				<table border="1" class="table">
					...
					<tr>
						...
						<td style="width:200px;">${DrvPunishInfo.caseid }</td>
					    <th style="text-align: right;width: 100px;">车牌号：</th>
						<td style="width:200px;">${DrvPunishInfo.carid }
						</td>
					</tr>
					<tr>
						<th style="text-align: right;width: 100px;">驾驶证号：</th>
						<td  style="width:200px;">${DrvPunishInfo.drivcarno }</td>
					    <th style="text-align: right;width: 100px;">案件来源：</th>
						<td  style="width:200px;">
						<c:choose>
						     <c:when test="${DrvPunishInfo.casesource=='01'}">稽查执法查扣违章</c:when>
						      <c:when test="${DrvPunishInfo.casesource=='02'}">信访投诉违章</c:when>
						</c:choose></td>
					</tr>
					<tr>
						<th style="text-align: right;width: 100px;">行政区划：</th>
						<td  style="width:200px;">${DrvPunishInfo.areacode }</td>
					    <th style="text-align: right;width: 100px;">组织机构：</th>
						<td  style="width:200px;">${DrvPunishInfo.createinstid }</td>
					</tr>
					<tr>
					    <th style="text-align: right;width: 100px;">案发时间：</th>
						<td  style="width:200px;">${DrvPunishInfo.casetime }</td>
						<th style="text-align: right;width: 100px;">修改时间：</th>
						<td  style="width:200px;">${DrvPunishInfo.updatetime }</td>
					</tr>
					<tr height="30px">
						<th style="text-align: right;">案件登记人：</th>
						<td colspan="3">${DrvPunishInfo.caseuserid }</td>
					</tr>
					<tr height="30px">
						<th style="text-align: right;">案件事由：</th>
						<td colspan="3">${DrvPunishInfo.casereason }</td>
					</tr>
					<tr>
