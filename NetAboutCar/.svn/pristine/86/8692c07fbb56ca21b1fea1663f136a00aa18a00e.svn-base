...
<form  action="comitcomp.action" name="addForm" id="addForm" method="post" enctype="multipart/form-data" >
		...
		<table border="1" class="table">	      
			<tr>
	         ...
	         <tr>
	             <td style="text-align: center;">${drvcomplainappeal.appl_time}</td>
	             <td style="text-align: center;">投诉对象</td>
	             <td style="text-align: center;">${drvcomplainappeal.appl_peo}</td>
	             <td style="text-align: center;">投诉申诉</td>
	             <td style="text-align: center;">${drvcomplainappeal.appl_content}</td>
	         </tr>
	         </c:if>
	          <c:if test="${drvcomplaintinfo.compn_state=='7'}">
	         <tr>
	             <td style="text-align: center;">${drvcomplaindispose.appl_idea_time}</td>
	             <td style="text-align: center;">处理部门</td>
	             <td style="text-align: center;">${drvcomplaindispose.appl_idea_peo}</td>
	             <td style="text-align: center;">申诉处理</td>
	             <td style="text-align: center;">${drvdisappeal.disappeal_idea}</td>
	         </tr>
	         </c:if>
