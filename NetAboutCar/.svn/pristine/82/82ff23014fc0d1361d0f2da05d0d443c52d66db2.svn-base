package com.nasoft.aboutcar.car.domain;
...
public class CarChangeApply {
	...
	private String externalExploration;
	private String changeProperty;
	private String appStatus;
	private String applyType;
	private String remark;
	private int createMan;
	private int createInstId;
	private String createDate;
	private int updUserId;
	private int updInstId;
	...
	public String getExternalExploration() {
		return externalExploration;
	}
	public void setExternalExploration(String externalExploration) {
		this.externalExploration = externalExploration;
	}
