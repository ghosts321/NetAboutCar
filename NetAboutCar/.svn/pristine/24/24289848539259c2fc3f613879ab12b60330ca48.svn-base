 ...
 * 驾驶员违章违法信息表
 */
public class DrvIllegalInfo {
    private String drv_illegal_id;
	...
	public String getDrv_illegal_id() {
		return drv_illegal_id;
	}

	public void setDrv_illegal_id(String drv_illegal_id) {
		this.drv_illegal_id = drv_illegal_id;
	}
	...
	public String getIllegal_source() {
		return illegal_source;
	}

	public void setIllegal_source(String illegal_source) {
		this.illegal_source = illegal_source;
	}
