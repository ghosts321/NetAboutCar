...
<body>
   <div class="container" style="margin-top:30px;">
    <form action="updateRole.action" name="roleInfoForm" id="roleInfoForm" method="post">
    	<div id="zhongxin">
    	...
    	<table>
			<tr>
				...
				<td><input type="text" name="roleName" id="roleName" value="${roleInfo.roleName }" maxlength="32" placeholder="这里输入角色描述" title="角色名称"/></td>
			</tr>
			<tr>
				<td style="width:30%;text-align: right;"><font color="red">*  </font>角色描述:</td>
				<td><input type="text" name="remark" id="remark" value="${roleInfo.remark }" maxlength="32" placeholder="这里输入角色描述" title="角色描述"/></td>
			</tr>
			<tr>
