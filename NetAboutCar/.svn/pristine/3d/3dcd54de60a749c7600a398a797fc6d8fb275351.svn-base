		  	...
		  	<div style="padding-top:10px;" class="tab-content">
		  		<div class="panel panel-default">
		            <div class="panel-body">
		                ...
		                <form action="<%=basePath %>drvcomplaint/drvComplaintStatistics.action" method="post" name="form1" id="form1" class="form-horizontal">
		                    <div class="form-group">
		                    	<div id="addressInfo">
									<label class="control-label col-sm-1" style="font-weight: normal;" for="compn_compy">驾驶证号码</label>
			                        <div class="col-sm-1" style="padding-right:5px;padding-left: 0px">
										<input style="width:180px" type="text"  name="driver_licence" id="driver_licence" placeholder="驾驶证号码" />
			                        </div>
								</div>
